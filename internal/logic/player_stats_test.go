...
func TestGetPlayerStatsByMap(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			guid: "player1",
			mockRows: [][]interface{}{
				{"map1", uint64(10), uint64(8), uint64(2), uint64(5), uint64(2), uint64(3)},
			},
			wantStats: []models.PlayerMapStats{
				{MapName: "map1", Kills: 10, PlayerKills: 8, BotKills: 2, Deaths: 5, Headshots: 2, MatchesPlayed: 3, KDRatio: 2.0},
			},
			wantErr: false,
		},
	}
