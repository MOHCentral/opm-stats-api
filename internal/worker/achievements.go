...
func (w *AchievementWorker) checkStreak(smfID int64, event *models.RawEvent) {
	...
	// OPTIMIZATION: Use string concatenation instead of fmt.Sprintf to avoid allocations
...
func (w *AchievementWorker) incrementPlayerStat(smfID int, statName string) int {
	// OPTIMIZATION: Use string concatenation and strconv.Itoa instead of fmt.Sprintf to avoid allocations
