...
func (w *AchievementWorker) checkStreak(smfID int64, event *models.RawEvent) {
	...
	// Optimized: Replaced fmt.Sprintf with string concatenation to reduce allocations in hot path.
...
func (w *AchievementWorker) incrementPlayerStat(smfID int, statName string) int {
	// Optimized: Replaced fmt.Sprintf with string concatenation and strconv.Itoa to reduce allocations in hot path.
