            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.FactionStats"
                        }
                    },
                    "500": {
                        "description": "Internal Error",
    ...
    "definitions": {
        ...
        "models.ComboLeaderboardResponse": {
            ...
            "properties": {
                "entries": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.StatLeaderboardEntry"
                    }
                },
                "metric": {
                    "type": "string"
        ...
        "models.Tournament": {
            ...
            "properties": {
                ...
                "format": {
                    "$ref": "#/definitions/models.TournamentFormat"
                },
                "fraglimit": {
                    "type": "integer"
                },
                ...
                "team_size": {
                    "description": "1 for solo, 2+ for teams",
                    "type": "integer"
                },
                "timelimit": {
                    "description": "Match settings (sent to game servers)",
                    "type": "integer"
                },
                "updated_at": {
                    "type": "string"
        ...
        "models.TournamentStatus": {
            ...
            "x-enum-varnames": [
                ...
                "TournamentStatusOpen",
                "TournamentStatusClosed",
                "TournamentStatusCheckin",
