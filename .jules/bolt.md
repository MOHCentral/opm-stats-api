...
## 2024-05-18 - String Building Optimization
**Learning:** Using `fmt.Sprintf` for simple string concatenations and integer conversions in hot paths causes unnecessary reflection and heap allocation overhead.
**Action:** Always prefer string concatenation and `strconv.Itoa` when building predictable keys or strings in high-frequency functions.
